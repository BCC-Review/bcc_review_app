...
void main() {
  testWidgets('LifeIndicator deve exibir N vidas corretamente', (WidgetTester tester) async {
    ...
    expect(find.byIcon(Icons.favorite), findsNWidgets(3));  // Verifica se há 3 ícones de vida
  });
}
