...
void main() {
  testWidgets('ProgressBar deve exibir progresso corretamente', (
    WidgetTester tester,
  ) async {
    // Widget para testar
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: ProgressBar(current: 3, total: 5))),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: ProgressBar(current: 0, total: 5))),
    );
    ...
    final zeroProgressIndicator = tester.widget<LinearProgressIndicator>(
      find.byType(LinearProgressIndicator),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(home: Scaffold(body: ProgressBar(current: 5, total: 5))),
    );
    ...
    final fullProgressIndicator = tester.widget<LinearProgressIndicator>(
      find.byType(LinearProgressIndicator),
    );
